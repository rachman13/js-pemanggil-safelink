...
if(x=="5"){xxx="/2017/09/how-to-solve-eating-difficulty-in.html"}a_to_ve[i].href="http://www.gaptekpoi.tk"+xxx+"?url="+ encryptedUrl;a_to_ve[i].rel="nofollow";a_to_vb++;a_to_vc+=i+":::"+ a_to_ve[i].href+"\n";}}
